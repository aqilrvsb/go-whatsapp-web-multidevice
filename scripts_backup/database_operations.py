...
class DatabaseManager:
    ...
    def connect_postgresql(self):
        ...
        try:
            ...
            if not pg_url:
                print("❌ No PostgreSQL connection string found. Please set DB_URI or DATABASE_URL in .env")
            ...
            if 'railway.internal' in pg_url:
                print("⚠️  Internal Railway URL detected. Please use the public URL instead.")
            ...
            with self.pg_conn.cursor() as cur:
                ...
                print(f"✅ Connected to PostgreSQL: {db_info[2]}:{db_info[3]}/{db_info[0]} as {db_info[1]}")
            return True
        except Exception as e:
    ...
    def export_mysql_schema(self):
        ...
        try:
            ...
            print("✅ MySQL schema exported to MYSQL_SCHEMA_DOCUMENTATION.md")
            
        except Exception as e:
            print(f"❌ Error exporting MySQL schema: {e}")
    ...
    def clear_postgresql_tables(self):
        ...
        try:
            with self.pg_conn.cursor() as cur:
                print("\n🧹 Clearing PostgreSQL tables to free disk space...\n")
                ...
                print("✅ VACUUM completed - disk space reclaimed")
                ...
                print(f"\n📊 Current database size: {db_size[1]}")
...
def main():
    ...
    if mysql_connected:
        print("\n2️⃣ Exporting MySQL schema documentation...\n")
        db.export_mysql_schema()
    
    if pg_connected:
        print("\n3️⃣ PostgreSQL disk usage before cleanup:\n")
        db.show_postgresql_disk_usage()
        
        print("\n4️⃣ Clearing PostgreSQL tables...\n")
        db.clear_postgresql_tables()
        
        print("\n5️⃣ PostgreSQL disk usage after cleanup:\n")
        db.show_postgresql_disk_usage()

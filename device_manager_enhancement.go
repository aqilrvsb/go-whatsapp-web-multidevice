// Add this method to DeviceManager in manager.go
// This unifies all client management into DeviceManager
...
func (dm *DeviceManager) GetOrRefreshClient(deviceID string) (*whatsmeow.Client, error) {
	...
	// Perform refresh (same as WorkerClientManager.performRefresh)
